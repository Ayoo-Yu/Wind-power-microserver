...
def train_model():
    ...
    forecast_timestamp_str = datetime.datetime.utcnow().strftime("%Y%m%d%H%M%S")
    source_basename = sanitize_filename(os.path.basename(upload_path), fallback="dataset.csv")
