"""Short-term (24h) pipeline configuration.

Thin wrapper around :pymod:`config_base` with short-specific parameters.
"""
import os
import sys
...
# Variant-specific overrides for short
VARIANT_PARAMS["TASK_TYPE"] = "short"
VARIANT_PARAMS["TIME_HORIZON_HOURS"] = 24
VARIANT_PARAMS["USE_FARM_CODE"] = True
VARIANT_PARAMS["LOG_PREFIX"] = ""
VARIANT_PARAMS["THREAD_NAME_SUFFIX"] = ""
