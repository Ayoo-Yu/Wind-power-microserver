...
from data_processor_short import load_data, preprocess_data, split_data, feature_engineering, scale_data, create_time_window
from models_short import get_lightgbm_params, add_new_param_version, save_param_versions_to_file, get_latest_param_version
...
def optimize_params():
    ...
    for i, (algo_type, boosting_type) in enumerate(zip(algo_types, boosting_types)):
        ...
        # 计算评分
        try:
            score, rmse, k, _, _ = evaluate_with_time_weights(y_val_windows, y_pred, timestamps)
