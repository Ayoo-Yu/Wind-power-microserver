...
WINDOW_SIZE = 16
TRAIN_RATIO = 0.9
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))  # 当前脚本目录 (/app/auto_scripts/scripts/short)
...
FEATURE_IMPORTANCE_DIR = os.path.join(CURRENT_DIR, 'feature_importance') # 直接在   short 目录下
# 将训练预测输出也放在相对路径下
